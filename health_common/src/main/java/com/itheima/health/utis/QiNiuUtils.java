...
public class QiNiuUtils {
    private static final String ACCESSKEY = "_juTBN-1v8kujY9N3_BAfQlRfTXZbVzVM69qy-qd";
    private static final String SECRETKEY = "eDpLNicbfSFVQvjnqVCmHEnlqtRfNEcY8O_KqAcC";
    private static final String BUCKET = "szz100";
    public static final String DOMAIN= "http://qh04ti4ns.hn-bkt.clouddn.com/";
