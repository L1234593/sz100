package com.itheima.health.utis;
...
public class SMSUtils {
    public static final String VALIDATE_CODE = "SMS_177536930";//发送短信验证码 改成自己的
    public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
    private static final String SIGN_NAEM = "黑马程序员";// 短信的签名
    private static final String PARAMETER_NAME="code";
    private static final String ACCESS_KEY="LTAI4FutJo421QfJJTkgSCWU"; //你的AccessKey ID
    private static final String SECRET_KEY="nRcWp7pYd0o4DKjNO0u0UkwVa5GOEm"; //你的AccessKey Secret

    public static void main(String[] args) throws ClientException {
            SMSUtils.sendShortMessage(VALIDATE_CODE,"19866050020","123456");
    }
