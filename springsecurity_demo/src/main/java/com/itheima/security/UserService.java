...
public class UserService implements UserDetailsService {
    ...
    /**
     * 获取登录用户的信息
     * @param username 从前端传进来的用户名
     * @return 返回登录用户信息、包含 security:user name="admin" password="{noop}admin" authorities="ROLE_ADMIN"
     *          用户名，数据库的密码，用户的权限信息
...
//                有角色
                for (Role role : roles) {
//                    授权角色keyword关键字，必须以ROLE_打头
//                    ？为什么要授权角色，支持使用角色做权限控制
